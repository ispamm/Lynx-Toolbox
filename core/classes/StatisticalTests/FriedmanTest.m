classdef FriedmanTest < StatisticalTest
    %WILCOXONTEST Compare the performance of several classifiers
    % using a corrected Friedman test. If the test reveals significant
    % differences, perform a set of post-hoc Nemenyi test between each pair
    % of algorithms. For informations on the tests, see: [1] J. Demšar,
    % “Statistical comparisons of classifiers over multiple data sets,” J.
    % Mach. Learn. Res., vol. 7, pp. 1–30, 2006. The confidence value is
    % set at alpha = 0.05;
