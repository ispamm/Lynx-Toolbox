...
% COMPARE_N_CLASSIFIERS Compare the performance of several classifiers
% using a corrected Friedman test. If the test reveals significant
% differences, perform a set of post-hoc Nemenyi test between each pair of
% algorithms. For informations on the tests, see: [1] J. Demšar,
% “Statistical comparisons of classifiers over multiple data sets,” J.
% Mach. Learn. Res., vol. 7, pp. 1–30, 2006.
%
%   COMPARE_N_CLASSIFIERS(DATANAMES, ALGONAMES, ERRORS) Perform a
%   statistical testing of the classifiers of name NAMES. The confidence
...
function compare_N_classifiers( data_names, algo_names, errors )
