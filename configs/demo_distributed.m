...
set_training_algorithm('CONS-ELM', @SerialDataDistributedRVFL, 'consensus_max_steps', 100);
...
add_feature(DistributeData(RandomTopology(2, 0.2), 'disable_check', 'disable_parallel'));
