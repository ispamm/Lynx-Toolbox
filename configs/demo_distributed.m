...
set_training_algorithm('ADMM-ELM', @DataDistributedRVFL, 'train_algo', 'admm', 'consensus_max_steps', 50, 'admm_max_steps', 20);

%add_dataset('G', 'G50C', 'g50c');
%add_dataset('G', 'Gtzan', 'gtzan_musicspeech');
%add_dataset('S', 'Sylva', 'sylva');
add_dataset('W', 'Wdbc', 'uci_wdbc');

add_feature(DistributeData(RandomTopology(4, 0.2)));
