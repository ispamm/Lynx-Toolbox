...
%add_model('ELM', 'Centralized ELM', @ExtremeLearningMachine, 'hiddenNodes', 500);
%add_model('LOC-ELM', 'Local ELM', @ExtremeLearningMachine, 'hiddenNodes', 500);
add_model('CONS-ELM', 'Distributed ELM (Consensus)', @ExtremeLearningMachine, 'hiddenNodes', 500);
%add_model('ADMM-ELM', 'ADMM-ELM', @ExtremeLearningMachine, 'hiddenNodes', 500);
...
set_training_algorithm('CONS-ELM', @SerialDataDistributedRVFL, 'C', 10, 'consensus_max_steps', 250, 'consensus_thres', 0.001, ...
    'consensus_noise', 0.001, 'consensus_prob', 0.75);
