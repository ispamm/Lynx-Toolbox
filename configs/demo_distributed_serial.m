...
set_training_algorithm('ADMM-ELM', @SerialDataDistributedRVFL, 'train_algo', 'admm', ...
    'consensus_max_steps', 100, 'admm_max_steps', 100, 'admm_rho', 1, 'admm_reltol', 0.001, 'admm_abstol', 0.001);
...
add_feature(InitializeTopology(RandomTopology(10, 0.2), 'disable_parallel', 'distribute_data'));
